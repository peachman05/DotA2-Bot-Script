...
function AbilityUsageThink()
	...
	then 
		print( "Use lina_light_strike_array 3" );
		npcBot:Action_UseAbilityOnLocation( abilityLSA, npcBot:GetLocation()  );

		local serverHTTPLoc = ""--"http://localhost:5000/success/22"
    	-- result = CreateHTTPRequest(  serverHTTPLoc )--:Send( function( result )
    
		   --  print( "GET response:\n" )
		   --  print(result)
		
		reee =	CreateHTTPRequest(  serverHTTPLoc )
		--hp_me,hp_enemy,mp_me,mp_enemy,distance,level_s1,level_s2,level_s3,cd_s1,cd_s2,cd_s3,output
		--400,400,200,150,700,2,2,1,10,15,10,0

		-- npcBot:GetHealth()
		-- npcBot:GetMana()
		-- GetLevel

		reee:SetHTTPRequestGetOrPostParameter("hp_me","400");
		reee:SetHTTPRequestGetOrPostParameter("hp_enemy","400");
		reee:SetHTTPRequestGetOrPostParameter("mp_me","200");
		reee:SetHTTPRequestGetOrPostParameter("mp_enemy","150");
		reee:SetHTTPRequestGetOrPostParameter("distance","700");
		reee:SetHTTPRequestGetOrPostParameter("level_s1","2");
		reee:SetHTTPRequestGetOrPostParameter("level_s2","2");
		reee:SetHTTPRequestGetOrPostParameter("level_s3","1");
		reee:SetHTTPRequestGetOrPostParameter("cd_s1","10");
		reee:SetHTTPRequestGetOrPostParameter("cd_s2","15");
		reee:SetHTTPRequestGetOrPostParameter("cd_s3","10");

		reee:Send( function( result )
